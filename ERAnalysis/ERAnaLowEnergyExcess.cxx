...
namespace ertool {
	...
	void ERAnaLowEnergyExcess::PrepareTreeVariables() {
		...
		_result_tree->Branch("_e_nuReco", &_e_nuReco, "e_nuReco/D", 64000);
		...
		_result_tree->Branch("_mcGeneration", &_mcGeneration, "mc_Generation/I", 64000);
		_result_tree->Branch("_longestTrackLen", &_longestTrackLen, "longest_tracklen/D", 64000);
		_result_tree->Branch("_x_vtx", &_x_vtx, "x_vtx/D", 64000);
		_result_tree->Branch("_y_vtx", &_y_vtx, "y_vtx/D", 64000);
		_result_tree->Branch("_z_vtx", &_z_vtx, "z_vtx/D", 64000);
		_result_tree->Branch("_perp_dist2wall_shr", &_perp_dist2wall_shr, "closest_perpendicular_dist2wall_shr/D", 64000);
		_result_tree->Branch("_perp_dist2wall_vtx", &_perp_dist2wall_vtx, "closest_perpendicular_dist2wall_vtx/D", 64000);
		_result_tree->Branch("_e_theta", &_e_theta, "_e_theta/D", 64000);
		_result_tree->Branch("_e_phi", &_e_phi, "_e_phi/D", 64000);
		_result_tree->Branch("_e_Edep", &_e_Edep, "_e_Edep/D", 64000);
		_result_tree->Branch("_e_CCQE", &_e_CCQE, "_e_CCQE/D", 64000);
		_result_tree->Branch("_nu_theta", &_nu_theta, "_nu_theta/D", 64000);
		_result_tree->Branch("_nu_pt", &_nu_pt, "_nu_pt/D", 64000);
		_result_tree->Branch("_nu_p", &_nu_p, "_nu_p/D", 64000);
		_result_tree->Branch("_n_children", &_n_children, "_n_children/I", 64000);
		_result_tree->Branch("_is_simple", &_is_simple, "_is_simple/O", 64000);
		_result_tree->Branch("_dedx", &_dedx, "dedx/D", 64000);
		_result_tree->Branch("_flash_time", &_flash_time, "flash_time/D", 64000);
		_result_tree->Branch("_summed_flash_PE", &_summed_flash_PE, "summed_flash_PE/D", 64000);
		_result_tree->Branch("_dist_2wall_shr", &_dist_2wall_shr, "dist_2wall_shr/D", 64000);
		_result_tree->Branch("_dist_2wall_vtx", &_dist_2wall_vtx, "dist_2wall_vtx/D", 64000);
		_result_tree->Branch("_dist_2wall_longz_shr", &_dist_2wall_longz_shr, "dist_2wall_longz_shr/D", 64000);
		_result_tree->Branch("_maybe_pi0_MID", &_maybe_pi0_MID, "_maybe_pi0_MID/O", 64000);
		_result_tree->Branch("_n_ertool_showers", &_n_ertool_showers, "_n_ertool_showers/I", 64000);
		_result_tree->Branch("_n_nues_in_evt", &_n_nues_in_evt, "n_nues_in_evt/I", 64000);
		_result_tree->Branch("_has_muon_child", &_has_muon_child, "_has_muon_child/O", 64000);
		_result_tree->Branch("_vertex_energy", &_vertex_energy, "_vertex_energy/D", 64000);
		_result_tree->Branch("_mc_origin", &_mc_origin, "_mc_origin/I", 64000);
		_result_tree->Branch("_mc_time", &_mc_time, "_mc_time/D", 64000);
		_result_tree->Branch("_trigger_hack_time", &_trigger_hack_time, "_trigger_hack_time/D", 64000);
		_result_tree->Branch("_mc_nu_energy", &_mc_nu_energy, "_mc_nu_energy/D", 64000);
