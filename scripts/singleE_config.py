...
def GetERSelectionInstance():
    ...
    #
    # This cut is applied in helper... ertool showers are not made if the
    ...
    # First we reconstruct nues and all that, then say if the electron's
    # associated flash is outside of the BGW we throw it out?
    ...
    # However, right now all solo shower particles are tagged as cosmic by the
    ...
    # tags the neutrino as a pi0 MID
